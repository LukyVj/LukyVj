...
2. 🗣 Commented on [#8](https://github.com/algolia/jekyll-algolia-example/issues/8) in [algolia/jekyll-algolia-example](https://github.com/algolia/jekyll-algolia-example)
